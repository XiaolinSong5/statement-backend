...
public enum Records {
    ...
    @JsonCreator
    public static Records toRecord(@JsonProperty("description") String description) {
       return Records.valueOf(description);
    }

    private Records(Long reference, String description, String alias, Integer priority) {
